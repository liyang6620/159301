...
if location == "All":
    ...
    selected_df['Crime_Rolling_Std_3'] = selected_df_grouped['Crime'].apply(lambda x: x.rolling(3,1).std()).reset_index(level=0, drop=True).reset_index(level=0, drop=True)
    selected_df['Crime_Rolling_Std_6'] = selected_df_grouped['Crime'].apply(lambda x: x.rolling(6,1).std()).reset_index(level=0, drop=True).reset_index(level=0, drop=True)
else:
    ...
    selected_df['Crime_Rolling_Std_3'] = selected_df['Crime'].rolling(3,1).std().reset_index(level=0, drop=True)
    selected_df['Crime_Rolling_Std_6'] = selected_df['Crime'].rolling(6,1).std().reset_index(level=0, drop=True)
